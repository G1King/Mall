    ...
    <div class="container">
        <div class="nav">
                ...
                <li>
                    <Dropdown placement="bottom-start">
                        <a href="javascript:void(0)">                
                            <Icon type="ios-pin" class="icon"/>{{city}}
                        </a>
            ...
            <ul class="detail">
               ...
               你好，请<router-link to="/login">登录<Icon type="ios-person"></Icon></router-link> | <span class="text-color-red"><router-link to="/SignUp">免费注册<Icon type="ios-person-add"></Icon></router-link></span>
                </li>
                        ...
                        <DropdownMenu slot="list">
                            <div class="my-page">
                                <div class="my-info">
                                    ...
                                    <Icon type="ios-home" @click="myInfo"></Icon>
                                    <p>我的主页</p>
                                </div>
                                <div class="sign-out" >
                                    <Icon type="ios-log-out" @click="signOutFun"></Icon>
                                    <p>退出登录</p>
                                </div>
                            </div>
                        </DropdownMenu>
                    ...
                    <Dropdown placement="bottom-start">
                        ...
                        <DropdownMenu slot="list">
                            ...
                            <div class="shopping-cart-list" v-show="shoppingCart.length > 0">
                                    ...
                                    <div class="shopping-cart-info">
                                        ...
                                        <div class="shopping-cart-detail">
                                            <p>
                                                ...
                                                价钱:
                                                <span class="shopping-cart-text">{{item.price}}</span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="go-to-by">
                                    <!-- @click="goToPay" -->
                                    <Button type="error" size="small" >去结账</Button>
                                </div>
                            </div>
